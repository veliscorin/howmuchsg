  ...
  return (
    <div className="p-8 max-w-lg mx-auto bg-gray-100 min-h-screen flex flex-col items-center justify-center">
      ...
      <p className="text-lg text-center text-gray-700">
        Welcome to HowMuch, your go-to app for tracking and comparing prices of items you purchase. Whether you are buying groceries, household items, or any other products, HowMuch helps you keep track of costs and make informed decisions. 
      </p>
